# Generated by Django 2.0.4 on 2018-05-05 16:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2018, 5, 5, 16, 50, 27, 711477))),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_django', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('description', models.CharField(max_length=200, null=True)),
                ('date', models.DateTimeField(default=datetime.datetime(2018, 5, 5, 16, 50, 27, 711030))),
